//-----------------------------------------------------------------------------
// Lab4 u2.cpp
// Uppgift 2 - Program för att beräkna samtalstaxa för RingPling2
...
bool userInputOnlyDigits(string possibleNum);										//Kontroll att angiven tid enbart är siffror
...
{
	//Kolla så tidsformatet är fem el fyra tecken långt för tid
...
//------------------------------------------------------------------------------
//userInputOnlyDigits
//Uppgift: Kontroll så att tiden enbart är i siffror
